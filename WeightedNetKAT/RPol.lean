...
def RPol.repr {F : Type} [i : Fintype F] [e : Encodable F] [Repr F] [Repr N] [Repr 𝒮] [Listed F] : RPol[F,N,𝒮] → String
...
instance {F : Type} [i : Fintype F] [e : Encodable F] [Repr F] [Repr N] [Repr 𝒮] [Listed F] : Repr RPol[F,N,𝒮] where
  reprPrec p _ := p.repr
